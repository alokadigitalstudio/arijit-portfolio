...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        className="container grid lg:grid-cols-2 gap-16 items-center py-20"
      ...
      >
        ...
        >
          <motion.span
            ...
            className="inline-flex items-center gap-2 rounded-full border border-blue-200/50 bg-blue-50/50 backdrop-blur-sm px-4 py-1.5 text-sm font-medium text-blue-700 mb-8"
          >
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-600 to-blue-500 px-8 py-3.5 text-white font-medium shadow-lg shadow-blue-600/25 hover:shadow-blue-600/40 transition-all duration-300"
            >
              View My Work
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-2 rounded-full border-2 border-slate-200 px-8 py-3.5 font-medium text-slate-700 hover:border-blue-600 hover:text-blue-600 transition-all duration-300"
            >
              Let's Talk
            </motion.a>
          </div>
        ...
        >
          ...
          {/* Image Container */}
          <div className="relative w-[440px] h-[440px] rounded-full p-1 bg-gradient-to-tr from-blue-500 via-blue-400 to-purple-500 shadow-2xl shadow-blue-500/20">
          ...
          <motion.div
            ...
            className="absolute -right-8 top-20 bg-white/80 backdrop-blur-md rounded-2xl px-4 py-3 shadow-xl border border-white/50"
          >
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
              <span className="text-sm font-medium text-slate-700">5+ Projects</span>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute -left-8 bottom-20 bg-white/80 backdrop-blur-md rounded-2xl px-4 py-3 shadow-xl border border-white/50"
          >
            <div className="flex items-center gap-2">
